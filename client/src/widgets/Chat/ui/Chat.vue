<template>
  <div class="bg-white dark:bg-darkBlue text-sm font-mono w-full px-4 py-2">
    <h2
      class="text-lg dark:text-white font-semibold mb-4 sticky top-0 dark:bg-darkBlue bg-white z-10"
    >
      {{ title }}
    </h2>
